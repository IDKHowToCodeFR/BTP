...
from agentic_selection.evaluation.protocol import run_stable_protocol, run_drift_protocol
...
def test_run_stable_protocol_produces_expected_row_count(synthetic_qws_normalized, controller, tmp_path):
    ...
    df = run_stable_protocol(
        synthetic_qws_normalized, QWS_ATTRIBUTE_COLUMNS, out_csv, controller,
