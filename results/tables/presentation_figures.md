...
`C:/Users/manga/Projects/github/IDKHowToCodeFR/BTP/results/figures/project_results_overview.png`

## QWS Task Heatmap

Task-level regret matrix separating known profiles from held-out requests.

`C:/Users/manga/Projects/github/IDKHowToCodeFR/BTP/results/figures/qws_regret_heatmap.png`

## QWS Regret Distribution

Trial-level distributions showing variance, central tendency, and outliers.

`C:/Users/manga/Projects/github/IDKHowToCodeFR/BTP/results/figures/qws_regret_distribution.png`
